...
int main( int argc, char* argv[] )
{
    ...
    create_file( dir_root,  "bashrc", 100 );
    create_file( dir_root,  "profile", 100 );
    create_file( dir_guest, "bashrc", 100 );
    create_file( dir_guest, "profile", 100 );
    create_file( dir_user,  "bashrc", 100 );
    create_file( dir_user,  "profile", 100 );
    create_file( dir_down,  "oblig2", 163033 );
